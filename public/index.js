...
"use strict";
var MineSweeperUI = require('./MineSweeperUI').default;
var element = document.getElementById('game');
var mineSweeper = new MineSweeperUI(element);


},{"./MineSweeperUI":"C:\\Users\\XzZy\\Desktop\\MineSweeper\\scripts\\client\\MineSweeperUI.js"}],"C:\\Users\\XzZy\\Desktop\\MineSweeper\\node_modules\\browserify\\node_modules\\process\\browser.js":[function(require,module,exports){
...
var Position = require('./Position').default;
...
($traceurRuntime.createClass)(Board, {
  ...
  addRandomMines: function(mines, excluded) {
    while (mines > 0) {
    ...
    for (var i = 0; i < this._board.length; i++) {
      for (var j = 0; j < this._board[0].length; j++) {
        if (this._board[i][j].revealed)
          repr += (this._board[i][j].minesAround + " ");
        else
          repr += '. ';
      }
      repr += '\n';
...
},{}],"C:\\Users\\XzZy\\Desktop\\MineSweeper\\scripts\\client\\MineSweeper.js":[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  default: {get: function() {
      return $__default;
...
var Position = require('./Position').default;
var MineSweeper = function MineSweeper(lines, cols, mines) {
  this.lines = lines || 10;
  this.cols = cols || 10;
...
},{"./Board":"C:\\Users\\XzZy\\Desktop\\MineSweeper\\scripts\\client\\Board.js","./Position":"C:\\Users\\XzZy\\Desktop\\MineSweeper\\scripts\\client\\Position.js"}],"C:\\Users\\XzZy\\Desktop\\MineSweeper\\scripts\\client\\MineSweeperUI.js":[function(require,module,exports){
"use strict";
Object.defineProperties(exports, {
  default: {get: function() {
      return $__default;
...
var MineSweeper = require('./MineSweeper').default;
var Position = require('./Position').default;
    ...
    for (var i = 0; i < this.mineSweeper.lines; i++) {
      ...
      for (var j = 0; j < this.mineSweeper.cols; j++) {
        ...
        button.addEventListener('click', (function(event) {
          ...
          console.log(event);
          if ($__2.mineSweeper.sweep(new Position(event.target.x, event.target.y))) {
            alert('You loose !');
          } else {
            if ($__2.mineSweeper.isWin())
              alert('You won !');
          }
          $__2.render();
        }));
        button.addEventListener('contextmenu', (function(event) {
          event.preventDefault();
          $__2.mineSweeper.mark(new Position(event.target.x, event.target.y));
          $__2.render();
        }));
